                    ...
                    <div className="card " style={{ width: 500 }}>
                        ...
                        <div className="card-body">
                            <form onSubmit={addNews} encType="multipart/form-data">
                                ...
                                <div>
                                    <div className="mb-3">
                                        <label htmlFor="topic_news" className="form-label">ข่าวประชาสัมพันธ์</label>
                                        <input onChange={onTextChange} type="text" className="form-control"
                                            name="topicNews" placeholder="หัวข้อข่าวประชาสัมพันธ์"
                                            value={topicNews} required onClick={onTextClick} />
                                    </div>
                                    <div className="mb-4">
                                        <label htmlFor="date" className="form-label">วันที่</label>
                                        <input onChange={onDateChange} type="date" className="form-control" name="date" defaultValue={date} />
                                    </div>
                                    <div className="mb-3">
                                        <input type="file" className="form-control" name="file" onChange={fileChange} required />
                                        <div className="form-text" >เนื้อหาข่าวประชาสัมพันธ์ ( .pdf )</div>
                                    </div>
