                    ...
                    <div className="card " style={{ width: 500 }}>
                        ...
                        <div className="card-body">
                            <form onSubmit={updateArticle} encType="multipart/form-data">
                                ...
                                <div>
                                    <div className="mb-3">
                                        <label htmlFor="topic_article" className="form-label">บทความวิชาการ</label>
                                        <input onChange={onTextChange} onClick={onTextClick}
                                            type="text" className="form-control" name="artTopic" required
                                            value={artTopic} placeholder="ชื่อบทความวิชาการ" />
                                    </div>
                                    <div className="mb-4">
                                        <label htmlFor="date" className="form-label">วันที่</label>
                                        <input type="date" className="form-control" name="artDate" value={date} onChange={onDateChange} />
                                    </div>
                                    <div className="mb-3">
                                        <label htmlFor="file" className="form-label"><Link to={`/file/articles/${fileName}`}
                                            target="_blank" rel="noopener noreferrer">{fileName}</Link></label>
                                        <input type="file" className="form-control" onChange={onfileChange} name="fileArticle" />
                                        <div id="fileHelp" className="form-text">เนื้อหาบทความวิชาการ ( .pdf )</div>
                                    </div>
                                    <button type="submit" className="btn btn-success" style={{ width: 90 }}>แก้ไข</button>
                                </div>
                            </form>
                        </div>
                    </div>
