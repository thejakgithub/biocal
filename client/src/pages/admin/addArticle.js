                            ...
                            {success &&
                                ...
                                <div>
                                    ...
                                    <div className="mb-4">
                                        ...
                                        <input type="date" className="form-control" name="artDate"  value={artDate} onChange={onDateChange}/>
                                    </div>
                                    <div className="mb-3">
                                        <input type="file" className="form-control"  onChange={onfileChange} name="artFile" required />
                                        <div id="fileHelp" className="form-text">เนื้อหาบทความวิชาการ ( .pdf )</div>
                                    </div>
                                    <button type="submit" className="btn btn-success" style={{ width: 90 }}>เพิ่ม</button>
                                </div>
                            </form>
                        </div>
                    </div>
